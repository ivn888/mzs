...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="cod_istat"/>
    <edittype labelontop="0" editable="1" type="0" name="cod_pro"/>
    <edittype labelontop="0" editable="1" type="0" name="id"/>
    <edittype labelontop="0" editable="1" type="0" name="nome"/>
    <edittype labelontop="0" editable="1" type="0" name="pro_com"/>
  </edittypes>
  <editform>.</editform>
